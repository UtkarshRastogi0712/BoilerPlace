...
export function activate(context: vscode.ExtensionContext) {
  ...
  let init = vscode.commands.registerCommand("boilerplace.init", async () => {
    ...
    if (vscode.workspace.workspaceFolders !== undefined) {
      ...
      console.error(vscode.Uri.joinPath(origin, "../boilerplace.json"));
      fs.writeFile(
        /*vscode.Uri.joinPath(origin, "/boilerplace.json").toString()*/ "C:/Users/Asus/Documents/testdump/boilerplace.json",
